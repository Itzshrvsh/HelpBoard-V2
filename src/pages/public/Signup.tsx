...
export default function Signup() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const msg = err.code === 'auth/email-already-in-use' ? 'Email already in use' : err.code === 'auth/weak-password' ? 'Password is too weak' : err.message;
      setError(msg);
    } finally {
      setLoading(false);
    }
      ...
      >
        <div className="glass rounded-2xl p-8 border border-surface-800/50">
          <div className="text-center mb-8">
            ...
            <p className="text-surface-400 text-sm mt-1">Join HelpBoard today</p>
          </div>
